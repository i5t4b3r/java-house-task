...
public class Main {
    ...
    static void printLocation(int floorQuantity, int entrancesQuantity, int apartment) {
        ...
        if (apartment % apartmentsQuantityFloor == 0) {
            floorCount = (apartment / apartmentsQuantityFloor) - floorQuantity * (entrancesCount - 1);
        } else {
            floorCount = (apartment / apartmentsQuantityFloor + 1) - floorQuantity * (entrancesCount - 1);
        }

        String location = switch (apartment % apartmentsQuantityFloor) {
